    ...
    return (
        <div className="hidden flex-1 lg:flex h-full flex-col items-center justify-center gap-6 border-t">
            <div className="flex flex-col items-center gap-3">
                ...
                <p className="text-lg font-semibold tracking-tight text-foreground">Preview will appear here</p>
                <p className="max-w-64 text-center text-sm text-muted-foreground">
                    Once you generate, your audio result will appear here. Sit back and realx.
                </p>
            </div>
            <Button variant="outline" size="sm" asChild>
                <Link href="mailto:buisness@sofiane.com">
                    <BookOpen />
                    Don&apos;t know how?
                </Link>
            </Button>
